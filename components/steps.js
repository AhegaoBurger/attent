...
Steps.defaultProps = {
  step1Title: "Browse our Collection",
  step2Title: "Select Your Favorites",
  step4Title: "Enjoy Your Jewelry",
  step4Description:
    "Adorn yourself with stunning jewelry that combines quality craftsmanship with affordable prices.",
  step3Title: "Place Your Order",
  step1Description:
    "Discover a wide range of beautifully crafted jewelry pieces to suit every style and occasion.",
  step3Description:
    "Easily place your order online and enjoy fast and reliable shipping to your doorstep.",
  step2Description:
    "Choose from our selection of rings, necklaces, earrings, and bracelets to find the perfect pieces for you.",
};
